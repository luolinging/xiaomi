		...
		<div class="site-category"
			...
			<div class="site-category-detail"
				...
				<ul class="category-items" v-for="goods in filterCurrGoods">
					<!-- 浏览左边的项，将会在右边显示该项下的子部件，所以，子部件的位置在右边，写在了这里 -->
...
.site-category-detail { /* 左边商品的分类详情  */
	position: absolute;
	display: flex;
